...
| [GetForeignKeys](#getgoreignkeys) | Returns list of foreign keys of the table. |
...
| [GetStmtFetchBookmarkPtr](#getstmtfetchBbokmarkPtr) | Gets a pointer that points to a binary bookmark value. |
...
```
FUNCTION ColBaseTableName (BYVAL ColNum AS SQLUSMALLINT) AS DWSTRING
```
...
```
FUNCTION ColCatalogName (BYVAL ColNum AS SQLUSMALLINT) AS DWSTRING
```
...
```
FUNCTION ColLiteralPrefix (BYVAL ColNum AS SQLUSMALLINT) AS DWSTRING
```
...
```
FUNCTION ColLiteralSuffix (BYVAL ColNum AS SQLUSMALLINT) AS DWSTRING
```
...
```
FUNCTION ColLocalTypeName (BYVAL ColNum AS SQLUSMALLINT) AS DWSTRING
```
...
```
FUNCTION ColSchemaName (BYVAL ColNum AS SQLUSMALLINT) AS DWSTRING
```
...
```
FUNCTION ColTableName (BYVAL ColNum AS SQLUSMALLINT) AS DWSTRING
```
...
```
FUNCTION ColTypeName (BYVAL ColNum AS SQLUSMALLINT) AS DWSTRING
```
...
```
FUNCTION GetCursorName () AS DWSTRING
```
...
```
FUNCTION GetData (BYVAL ColumnNumber AS SQLUSMALLINT, BYVAL maxChars AS LONG = 256 * 2) AS DWSTRING
FUNCTION GetData (BYREF ColumnName AS WSTRING, BYVAL maxChars AS LONG = 256 * 2) AS DWSTRING
```
...
```
FUNCTION GetImpParamDescFieldName (BYVAL RecNumber AS SQLSMALLINT) AS DWSTRING
```
...
```
FUNCTION GetImpRowDescFieldName (BYVAL RecNumber AS SQLSMALLINT) AS DWSTRING
```
...
```
FUNCTION GetLongVarcharData (BYVAL ColumnNumber AS SQLSMALLINT) AS DWSTRING
FUNCTION GetLongVarcharData (BYREF ColumnName AS WSTRING) AS DWSTRING
```

...
| [GetRawText](#getrawtext) | Gets the raw text exactly as it appears in memory. |
| [GetRawTextLength](#getrawtextlength) | Gets the length of the raw text |
...
| [SaveRawText](#saverawtext) | Saves the raw contents of the rich edit control to a file. |

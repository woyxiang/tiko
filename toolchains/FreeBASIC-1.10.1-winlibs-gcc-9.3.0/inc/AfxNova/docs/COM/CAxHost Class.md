...
| Name       | Description |
| ---------- | ----------- |
| [CAXHOST_AMBIENTDISP structure](#caxhost_ambiendisp) | Contains information the ambient properties of the CAxHost control. |
...
## <a name="caxhost_ambiendisp"></a>CAXHOST_AMBIENTDISP Structure

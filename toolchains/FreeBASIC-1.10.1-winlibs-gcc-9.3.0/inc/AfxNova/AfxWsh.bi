...
TYPE Afx_IWshNetwork_ EXTENDS Afx_IDispatch
   ...
   DECLARE ABSTRACT FUNCTION MapNetworkDrive (BYVAL LocalName AS AFX_BSTR, BYVAL RemoteName AS AFX_BSTR, BYVAL UpdateProfile AS VARIANT PTR, BYVAL UserName AS VARIANT PTR, BYVAL Password AS VARIANT PTR) AS HRESULT
   DECLARE ABSTRACT FUNCTION RemoveNetworkDrive (BYVAL Name AS AFX_BSTR, BYVAL Force AS VARIANT PTR, BYVAL UpdateProfile AS VARIANT PTR) AS HRESULT
   DECLARE ABSTRACT FUNCTION EnumNetworkDrives (BYVAL out_Enum AS Afx_IWshCollection PTR PTR) AS HRESULT
   DECLARE ABSTRACT FUNCTION AddPrinterConnection (BYVAL LocalName AS AFX_BSTR, BYVAL RemoteName AS AFX_BSTR, BYVAL UpdateProfile AS VARIANT PTR, BYVAL UserName AS VARIANT PTR, BYVAL Password AS VARIANT PTR) AS HRESULT
   DECLARE ABSTRACT FUNCTION RemovePrinterConnection (BYVAL Name AS AFX_BSTR, BYVAL Force AS VARIANT PTR, BYVAL UpdateProfile AS VARIANT PTR) AS HRESULT
...
TYPE Afx_IWshShell_ EXTENDS Afx_IDispatch
   ...
   DECLARE ABSTRACT FUNCTION get_Environment (BYVAL Type AS VARIANT PTR, BYVAL out_Env AS Afx_IWshEnvironment PTR PTR) AS HRESULT
   DECLARE ABSTRACT FUNCTION Run (BYVAL Command AS AFX_BSTR, BYVAL WindowStyle AS VARIANT PTR, BYVAL WaitOnReturn AS VARIANT PTR, BYVAL out_ExitCode AS INT_ PTR) AS HRESULT
   DECLARE ABSTRACT FUNCTION Popup (BYVAL Text AS AFX_BSTR, BYVAL SecondsToWait AS VARIANT PTR, BYVAL Title AS VARIANT PTR, BYVAL Type AS VARIANT PTR, BYVAL out_Button AS INT_ PTR) AS HRESULT
   ...
   DECLARE ABSTRACT FUNCTION RegWrite (BYVAL Name AS AFX_BSTR, BYVAL Value AS VARIANT PTR, BYVAL Type AS VARIANT PTR) AS HRESULT
...
TYPE Afx_IWshShell2_ EXTENDS Afx_IWshShell
   ...
   DECLARE ABSTRACT FUNCTION AppActivate (BYVAL App AS VARIANT PTR, BYVAL Wait AS VARIANT PTR, BYVAL out_Success AS VARIANT_BOOL PTR) AS HRESULT
   DECLARE ABSTRACT FUNCTION SendKeys (BYVAL Keys AS AFX_BSTR, BYVAL Wait AS VARIANT PTR) AS HRESULT
END TYPE
